...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* Sum: '<S2>/Sum' */
    rtb_Sum_k = 0.0 - heli_q8_B.Subtract;
    ...
    /* Gain: '<S5>/Kpp' incorporates:
     *  Sum: '<S5>/error'
     */
    heli_q8_B.Kpp = (heli_q8_B.Joystick_gain_x - heli_q8_B.PitchCounttorad) *
      heli_q8_P.Kpp;
  }
   ...
   *  Sum: '<S6>/Sum'
   */
  rtb_Frontgain = ((heli_q8_X.Integrator_CSTATE + heli_q8_B.K_ep) -
   ...
   *  Gain: '<S5>/Gain'
   */
  rtb_Backgain = heli_q8_B.Kpp - heli_q8_P.Kpd * heli_q8_B.PitchTransferFcn;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* Gain: '<S6>/K_ei' */
   ...
   *  Sum: '<S1>/Add'
   */
  u0 = (rtb_Frontgain - rtb_Backgain) * heli_q8_P.Frontgain_Gain;
   ...
   *  Sum: '<S1>/Subtract'
   */
  u0 = (rtb_Frontgain + rtb_Backgain) * heli_q8_P.Backgain_Gain;
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (2091216505U);
  heli_q8_M->Sizes.checksums[1] = (205257688U);
  heli_q8_M->Sizes.checksums[2] = (2019863034U);
  heli_q8_M->Sizes.checksums[3] = (3088432300U);
  ...
  heli_q8_M->Sizes.numBlocks = (46);   /* Number of blocks */
  heli_q8_M->Sizes.numBlockIO = (16);  /* Number of block outputs */
  heli_q8_M->Sizes.numBlockPrms = (146);/* Sum of parameter "widths" */
  return heli_q8_M;
}
